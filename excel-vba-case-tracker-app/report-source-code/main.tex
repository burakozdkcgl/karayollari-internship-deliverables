...
\begin{titlepage}
    ...
    \begin{minipage}{0.85\textwidth}
        ...
        \begin{tcolorbox}[
            ...
            \hspace{8pt}%
            $\vcenter{\hbox{%
                \href{https://github.com/kullaniciadi/proje-linki}{%
                    \tcbox[
                        on line,
                        colback=primary,
                        colframe=primary,
        ...
        \fboxsep=0pt
        \fboxrule=0.8pt
        \fcolorbox{bordergray}{white}{\includegraphics[width=14cm, keepaspectratio]{wallpaper.jpg}}
...
\input{about.tex}
\input{advicestouser.tex}
\input{troubleshooting.tex}
\input{files.tex}
\input{basicvba.tex}
\input{maintenanceguide.tex}
\input{explainedmodules.tex}
\input{explainedmodulesparttwo.tex}
\input{contributionguide.tex}
